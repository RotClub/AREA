...
<div class="h-screen">
	<header
		class="bg-surface-600 w-full sticky top-0 h-16 flex flex-row justify-center items-center z-10">
		<a
			href="/"
			class="text-xl font-bold text-white absolute left-0 ml-4 flex flex-row space-x-2 justify-center items-center">
		...
		<div
			class="hidden absolute right-0 mr-4 md:flex flex-row items-center h-full space-x-8 aspect-1">
